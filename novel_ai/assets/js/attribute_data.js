document.addEventListener('DOMContentLoaded', () => {
    ...
    async function loadAttributes() {
        ...
        try {
            ...
            // Failed to fetch 오류인 경우 더 명확한 메시지 표시
                ...
                $attributesList.innerHTML = `
                    <div class="text-danger text-center">
                        ...
                        <div class="small text-muted">
                            서버 URL: ${getServerUrl('/api/attributes/all')}<br>
                            서버를 시작하려면: <code>cd server && node server.js</code>
                        </div>
                    </div>
                `;
            } else {
                $attributesList.innerHTML = `
                    <div class="text-danger text-center">✗ 로드 실패: ${errorMessage}</div>
                `;
            }
        }
    }
