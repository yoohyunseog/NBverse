        ...
        try {
            ...
            if (result.ok) {
                if (typeof window.addRightLog === 'function') {
                    ...
                    const hasData = dataText && dataText.trim().length > 0;
                    ...
                    if (hasData && dataBits && dataBits.max !== null && dataBits.min !== null) {
                        const attributeTextDisplay = finalAttributeText.length > 50 ? finalAttributeText.substring(0, 50) + '...' : finalAttributeText;
                        window.addRightLog('success', `[자동 저장] 데이터 BIT (속성 텍스트 "${attributeTextDisplay}"의 BIT 사용): MAX=${dataBits.max.toFixed(15)}, MIN=${dataBits.min.toFixed(15)}`);
                                                ...
                                                if (dataCount === 0) {
                                                    ...
                                                    try {
                                                        ...
                                                        if (currentDataText && currentDataText.length > 0) {
                                                            ...
                                                            // 데이터 BIT 값은 속성 BIT 값을 사용
                                                            saveDataBitMax = bits.max;
                                                            saveDataBitMin = bits.min;
                                                        } else {
                                                                ...
                                                                if (currentDataText) {
                                                                    ...
                                                                    if (typeof window.addRightLog === 'function') {
                                                                        ...
                                                                        if (saveDataBitMax !== null && saveDataBitMin !== null) {
                                                                            const attributeTextDisplay = attributeValue3.length > 50 ? attributeValue3.substring(0, 50) + '...' : attributeValue3;
                                                                            window.addRightLog('success', `[자동 저장] 데이터 BIT (속성 텍스트 "${attributeTextDisplay}"의 BIT 사용): MAX=${saveDataBitMax.toFixed(15)}, MIN=${saveDataBitMin.toFixed(15)}`);
